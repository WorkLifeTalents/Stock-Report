...
portfolio$Gewichtung <- portfolio$Preis * portfolio$Stück/cash

data <- data.frame(c(portfolio$Name,"Cash"),c(portfolio$Preis * portfolio$Stück, (cash - sum(portfolio$Preis * portfolio$Stück))))
colnames(data) <- c("Name", "Gewichtung")

fig <- plot_ly(data, labels = ~Name, values = ~Gewichtung, type = 'pie')
